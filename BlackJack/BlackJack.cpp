...
void BlackJack::play(int deposit) {
...
void BlackJack::playerTurn(int n) {
...
void BlackJack::blackJackCaseLogic() {
...
void BlackJack::standCaseLogic(int n) {
...
void BlackJack::hitCaseLogic(int n) {
...
void BlackJack::doubleCaseLogic() {
...
void BlackJack::compare(int n) {
	...
	if (this->_player.getHand(n).isBlackJack()) {
		...
		if (this->_dealer.getHand().isBlackJack()) {
			...
			this->_winnings += (int)(this->_bet * 1.5);
